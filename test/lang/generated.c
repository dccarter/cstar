...
typedef struct {
    string _0;
    i32 _1;
    __cxy_anonymous_tuple_21_t _2;
} __cxy_anonymous_tuple_22_t;

/* --------------------- Generated EPILOGUE --------------*/

extern i32 puts(string str);

i32 println(string str) { return puts(str); }

#define __CXY_MAIN_INVOKE(...)                                                 \
    __cxy_main(__VA_ARGS__);                                                   \
    return EXIT_SUCCESS

void __cxy_main(__cxy_anonymous_array_20_t args)
{
    const __cxy_anonymous_tuple_22_t name = (__cxy_anonymous_tuple_22_t){
        ._0 = "User",
        ._1 = 22,
        ._2 = (__cxy_anonymous_tuple_21_t){
            ._0 = 100, ._1 = 900, ._2 = "Street St"}};
    println(({
        __cxy_string_builder_t sb = {};
        __cxy_string_builder_init(&sb);
        __cxy_string_builder_append_cstr0(&sb, "Hello ", 6);
        __cxy_string_builder_append_cstr1(&sb, name._0);
        __cxy_string_builder_append_cstr0(&sb, ", you are ", 10);
        __cxy_string_builder_append_int(&sb, name._1);
        __cxy_string_builder_append_cstr0(
            &sb, " years old, your address is ", 28);
        __cxy_string_builder_append_char(&sb, '(');
        __cxy_string_builder_append_int(&sb, name._2._0);
        __cxy_string_builder_append_cstr0(&sb, ", ", 2);
        __cxy_string_builder_append_int(&sb, name._2._1);
        __cxy_string_builder_append_cstr0(&sb, ", ", 2);
        __cxy_string_builder_append_cstr1(&sb, name._2._2);
        __cxy_string_builder_append_char(&sb, ')');
        __cxy_string_builder_release(&sb);
    }));
}
