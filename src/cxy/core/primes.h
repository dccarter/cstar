...
#define PRIMES(f)                                                              \
    f(MIN_PRIME) f(17) f(31) f(67) f(257) f(1031) f(4093) f(8191) f(16381)     \
        f(32381) f(65539) f(131071) f(262147) f(524287) f(MAX_PRIME)
...
static inline size_t nextPrime(size_t i)
{
...
static inline size_t modPrime(size_t i, size_t p)
{
    switch (p) {
#define f(x)                                                                   \
    case x:                                                                    \
