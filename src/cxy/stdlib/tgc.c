...
static void tgc_add_ptr(
    tgc_t *gc, void *ptr, size_t size, int flags, void (*dtor)(void *))
{
    ...
    tgc_t *gc, void *ptr, size_t size, int flags, void (*dtor)(void *))
{
    ...
    gc->nitems++;
    gc->maxptr = ((uintptr_t)ptr) + size > gc->maxptr ? ((uintptr_t)ptr) + size
                                                      : gc->maxptr;
...
void *tgc_calloc_opt(
    tgc_t *gc, size_t num, size_t size, int flags, void (*dtor)(void *))
{
